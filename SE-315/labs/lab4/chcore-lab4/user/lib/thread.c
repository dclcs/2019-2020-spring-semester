...
{
	// printf("create_thread called! thread_num_in_progress: %d!!!!!!!!!\n", thread_num_in_process);
	...
	child_thread_cap = usys_create_thread(SELF_CAP, CHILD_THREAD_STACK_BASE + thread_num_in_process * CHILD_THREAD_STACK_SIZE,
										  (u64)func, arg, prio, cpuid);

	// printf("create_thread over! thread_num_in_progress: %d!!!!!!!!!\n", thread_num_in_process);
